...
public class registration2 extends AppCompatActivity {
    ...
    private EditText fname, lname, phno, adr, tenmrks, eml, psw, condept,twlmrks;
            ...
            public void onClick(View v) {
                if (checkFun()) {
                   ...
                   firebaseAuth.createUserWithEmailAndPassword(e_mail, pswd).addOnCompleteListener(new OnCompleteListener <AuthResult>() {
                    ...
                    DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Data Register2");
                    ...
                    Toast.makeText(getApplicationContext(), "Registration Successful", Toast.LENGTH_SHORT).show();
                    Intent change = new Intent(registration2.this, User1.class);
                    startActivity(change);
                } else {
